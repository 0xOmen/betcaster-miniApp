...
export default function CreateBet({
  ...
  const handleUserSelect = async (user: User) => {
    ...
    // Clear direct address when user is selected
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!e.target.value.trim()) {
      ...
      setTakerAddress(null); // Reset direct address when user is cleared
    }
  };
  ...
  const handleArbiterInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!e.target.value.trim()) {
      ...
      setArbiterAddress(null); // Reset direct address when arbiter is cleared
    }
  };
  ...
  const handleCreateBet = async () => {
    ...
    if (
      (!selectedUser && !isAnyoneSelected && !takerAddress) ||
      !selectedToken ||
      !betAmount ||
      !selectedTimeOption
    ) {
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            disabled={!!selectedUser || !!takerAddress}
            onChange={(e) => {
        ...
        <div>
          <div className="flex items-center space-x-2 mb-2">
            ...
            <button
              type="button"
              onClick={() => setShowBetAmountInfo(!showBetAmountInfo)}
          ...
          {showBetAmountInfo && (
            <div className="mb-3 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              <div className="text-sm text-blue-700 dark:text-blue-300">
                The Bet Amount is what each party wagers and what the Maker wins
                if they are right, minus fees.
              </div>
            </div>
          )}
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
