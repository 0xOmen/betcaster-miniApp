export const BET_MANAGEMENT_ENGINE_ABI = [
  ...
  {"inputs": [], "name": "BetManagementEngine__BetAmountMustBeGreaterThanZero", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__BetNotClaimable", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__BetNotInProcess", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__BetNotWaitingForArbiter", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__BetNotWaitingForTaker", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__BetTokenAddressCannotBeZeroAddress", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__EndTimeMustBeInTheFuture", "type": "error"},
  {"inputs": [], "name": "BetManagementEngine__MakerCannotBeZeroAddress", "type": "error"},
  ...
  {"inputs": [], "name": "BetManagementEngine__TakerCannotBeArbiterOrMaker", "type": "error"},
  ...
  {"inputs": [], "name": "ReentrancyGuardReentrantCall", "type": "error"},
  {
    "anonymous": false,
    "inputs": [
      {"indexed": true, "internalType": "uint256", "name": "betNumber", "type": "uint256"},
      {
        "components": [
          ...
          {"internalType": "enum BetTypes.Status", "name": "status", "type": "uint8"},
  ...
  },
  {
    ...
    "inputs": [
      {"indexed": true, "internalType": "uint256", "name": "betNumber", "type": "uint256"},
      {"indexed": true, "internalType": "address", "name": "calledBy", "type": "address"},
      {
        "components": [
          {"internalType": "address", "name": "maker", "type": "address"},
          {"internalType": "address", "name": "taker", "type": "address"},
  ...
  },
  {
    ...
    "inputs": [
      ...
      {"indexed": true, "internalType": "enum BetTypes.Status", "name": "status", "type": "uint8"}
    ],
    "name": "BetClaimed",
    "type": "event"
  },
...
export const BET_MANAGEMENT_ENGINE_ADDRESS = "0xEd1ca2Aef248c6DBD4160475cFf181B31Ed59c53" as const; 